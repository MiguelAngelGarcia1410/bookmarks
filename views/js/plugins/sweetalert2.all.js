...
(function (global, factory) {
  ...
  var setParameters = function setParameters(params) {
    ...
    // Set popup width
    var popupWidth =
      params.width === defaultParams.width && params.toast
        ? "auto"
        : params.width;
    popup.style.width =
      typeof popupWidth === "number" ? popupWidth + "px" : popupWidth;

    var popupPadding =
      params.padding === defaultParams.padding && params.toast
        ? "inherit"
        : params.padding;
    popup.style.padding =
      typeof popupPadding === "number" ? popupPadding + "px" : popupPadding;
      ...
      case "object":
        ...
        if (params.input === "email" && params.inputValidator === null) {
          ...
          params.inputValidator = params.expectRejections
            ? inputValidator
            : sweetAlert.adaptInputValidator(inputValidator);
        }
        ...
        if (params.input === "url" && params.inputValidator === null) {
          ...
          params.inputValidator = params.expectRejections
            ? _inputValidator
            : sweetAlert.adaptInputValidator(_inputValidator);
        }
        break;
    ...
    return new Promise(function (resolve, reject) {
      ...
      var getInput = function getInput(inputType) {
        ...
        switch (inputType) {
          ...
          case "radio":
            return (
              popup.querySelector("." + swalClasses.radio + " input:checked") ||
              popup.querySelector(
  ...
  var getPopup = function getPopup() {
    return getContainer()
      ? getContainer().querySelector("." + swalClasses.popup)
      : null;
  };
  ...
  var getFocusableElements = function getFocusableElements() {
    var focusableElementsWithTabindex = Array.from(
  ...
  var show = function show(elem, display) {
    if (!display) {
      display =
        elem === getPopup() || elem === getButtonsWrapper() ? "flex" : "block";
    }
    elem.style.opacity = "";
